     ...
     int lam1; int lam; int lam2;
{
  if (lam2!=0){
    ...
    return(sqrt((2.*i1+1)*(2.*i2+1)*(2.*l1+1)*(2.*l2+1)*
	   ...
	   wign9j((double)lam2,(double)lam,(double)lam1,
		  i2,(double)l1,i1,
		  i2,(double)l2,i1));
  }
  else{
    ...
    if (lam1==lam){
      return(sqrt((2.*i1+1)*(2.*l1+1)*(2.*l2+1)*(2.*lam+1))*
	     ...
	     wign3j((double)l1,(double)l2,(double)lam,1.,-1.,0.) *
	     wign6j(i1,i1,(double)lam,(double)l1,(double)l2,(double)i2));
    }
    else{
      return(0.);
    }
...
/* hi, MSU! */
double wiko_prot_f1(l1,l2,i1,i2,lam)
double l1; double l2; double i1; double i2;int lam;
{  
  return(sqrt((2.*i1+1)*(2.*l1+1)*(2.*l2+1)*(2.*lam+1))*
	 minuseinshoch((int)(i1+i2)+1)*
	 wign3j(l1,l2,(double)lam,-0.5,0.5,0.) *
	 wign6j(i1,i1,(double)lam,(double)l1,(double)l2,(double)i2));
}
