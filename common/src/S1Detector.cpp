#include "S1Detector.h"

#include <cmath>

using namespace std;

S1Detector::S1Detector(int nr, int nw, double inr, double outr, double z, double phirot, double cof) {
...
std::pair<double,double> S1Detector::GetThetaPhi(int iringch, int iwedgech) {
...
std::pair<double,double> S1Detector::GetCosThetaPhi(int iringch, int iwedgech) {
...
std::pair<int,int> S1Detector::GetRingWedge(double itheta, double iphi) {
...
std::pair<int,int> S1Detector::GetRingWedgeCos(double icostheta, double iphi) {
...
bool S1Detector::ValidRing(int r) {
  return ((r>=0&&r<num_rings) ? true : false);
}

bool S1Detector::ValidWedge(int w) {
